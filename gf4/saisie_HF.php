        ...
        <form action="hors_forfait.php?id=<?php $id; ?>" method="get">
            ...
            <h2>
                ...
                <table>
                    ...
                    <tr>
                        <td>
                            <input style="width:100%" type="text" name="Date" placeholder="Y-M-D">
                        </td>
                        <td>
                            <input style="width:100%" type="text" name="libelle">
                        </td>
                        <td>
                            <input style="width:100%" type="number" min=0 name="Montant">
                        </td>
